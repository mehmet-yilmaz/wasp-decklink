#ifndef _WEBSOCKET_CONNECTION_HPP_
#define _WEBSOCKET_CONNECTION_HPP_
...
namespace Wasp
{
    class WSApplication; // FWD

    class WSConnection : public oatpp::websocket::AsyncWebSocket::Listener, public Wasp::UUIDElement
    {
    private:
        /**
    ...
    private:
        ...
        std::shared_ptr<WSApplication> m_application;
        oatpp::String m_name;
    ...
    public:
        WSConnection(const std::shared_ptr<AsyncWebSocket> &socket,
                     const std::shared_ptr<WSApplication> &application,
         ...
         * @return
         */
        std::shared_ptr<WSApplication> getApplication()
        {
